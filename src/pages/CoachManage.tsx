...
export default function CoachManage() {
  ...
  return (
    <div>
      <h1 className="text-[30px] font-medium text-gray-dark md:text-[38px]">Manage</h1>
      ...
      <div className="mt-8 rounded-2xl border border-[#E5E5E5] p-6">
        <div className="flex items-start gap-5">
          ...
          <div className="min-w-0 flex-1">
            <h2 className="text-[22px] font-medium text-gray-dark">Samantha Parker</h2>
            <p className="mt-[2px] text-[16px] leading-[1.3] text-[#707070]">
              Experienced Product Leader at LinkedIn | Ex-Meta | Stanford GSB
            </p>
            <p className="mt-3 text-[14px] leading-[1.5] text-[#707070]">
            ...
            <div className="mt-4 flex flex-wrap items-center gap-x-5 gap-y-2 text-[14px] text-[#707070]">
      ...
      {/* Category listings */}
      <h2 className="mt-10 text-[22px] font-medium text-gray-dark">Category Listings</h2>
        ...
        {categoryListings.map(({ slug, category, headline }, i) => (
          ...
          >
            ...
            <Link
              ...
              className="inline-flex items-center justify-center gap-1.5 rounded-lg bg-gray-hover px-3.5 py-2.5 text-[12px] font-medium leading-[1.2] text-gray-dark transition-colors hover:bg-[#ebebeb]"
            >
              <img src={editIcon} alt="" className="h-4 w-4" />
              Edit
            </Link>
