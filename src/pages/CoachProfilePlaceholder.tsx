...
export default function CoachProfilePlaceholder() {
  ...
  return (
    <div>
      <h1 className="font-serif text-[30px] font-medium leading-[1.1] text-gray-dark md:text-[38px]">Profile</h1>
      <p className="mt-2 text-[16px] text-gray-light">
        A place for both customers and experts to edit their profile information. Note that some fields will be exclusive to expert profiles.
      </p>
