...
function TopBar({ session }: { session: Session }) {
  ...
  return (
    <div className="flex flex-col gap-1.5 lg:gap-2">
      ...
      <div className="text-[12px] text-gray-light lg:text-[15px]">
        AI Builder Program Level 1 · Session {session.number}
      </div>
      {/* Title — big bold */}
      <h1 className="text-[20px] font-medium leading-[1.1] text-gray-dark sm:text-[26px] lg:text-[30px]">
        {session.title}
      </h1>
      {/* Date · time · duration · attendance */}
      <div className="flex flex-wrap items-center gap-2 text-[11px] text-gray-light lg:gap-3 lg:text-[15px]">
        <span>
...
export default function V4({ session }: { session: Session }) {
