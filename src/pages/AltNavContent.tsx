...
// Placeholder destination for the v4 top-nav "Content" item. Content TBD — this
// just gives the nav item a real page to land on.
...
export default function AltNavContent() {
  useEffect(() => {
  ...
  return (
    <div>
      <h1 className="font-serif text-[30px] font-medium leading-[1.1] text-gray-dark md:text-[38px]">Content</h1>
      <p className="mt-2 text-[16px] text-gray-light">Guides, articles, and resources will show up here.</p>
