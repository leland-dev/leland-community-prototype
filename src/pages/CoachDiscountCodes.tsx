...
export default function CoachDiscountCodes() {
  useEffect(() => {
    document.title = "Leland Prototype | Discount Codes";
  }, []);

  return (
    <div>
      <h1 className="text-[32px] font-medium text-gray-dark md:text-[40px]">Discount Codes</h1>
