    ...
    <div className="leading-[1.2]">
      ...
      <div className="mb-4 flex items-start justify-between sm:mb-8">
        ...
        <div className="sticky hidden items-center gap-2 self-start sm:flex" style={{ top: "28px" }}>
          ...
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#ABABAB]">
              <path fillRule="evenodd" clipRule="evenodd" d="M19.5576 12C19.5576 10.5607 20.0416 10.1069 20.9907 9.3136C21.3602 9.00484 21.4496 8.47642 21.2065 8.06087L19.958 5.92733C19.7192 5.5192 19.2275 5.33623 18.7812 5.49252C17.5776 5.914 16.9371 6.09614 15.6531 5.3644C14.4143 4.6584 14.2584 4.01067 14.0365 2.80405C13.9505 2.33615 13.5427 2 13.067 2H10.5588C10.0831 2 9.67536 2.33611 9.58895 2.80391C9.36543 4.01395 9.20849 4.65486 7.96569 5.3644C6.68562 6.09523 6.04538 5.91277 4.84455 5.49234C4.39834 5.33612 3.90676 5.5191 3.66799 5.92714L2.41943 8.06087C2.17627 8.47642 2.26571 9.00484 2.63513 9.3136C3.5843 10.1069 4.06823 10.5607 4.06823 12C4.06823 13.4393 3.5843 13.8931 2.63513 14.6864C2.26571 14.9952 2.17627 15.5236 2.41943 15.9391L3.66788 18.0727C3.9067 18.4808 4.39844 18.6638 4.84464 18.5072C6.04397 18.0864 6.68738 17.9013 7.96569 18.6316C9.20881 19.3417 9.36573 19.9854 9.58906 21.196C9.67537 21.6639 10.0832 22 10.5589 22H13.0671C13.5428 22 13.9505 21.6639 14.0372 21.1962C14.2621 19.9824 14.42 19.3449 15.6668 18.6316C16.9415 17.9023 17.5846 18.0879 18.7812 18.5082C19.2274 18.6649 19.7192 18.4819 19.958 18.0738L21.2065 15.9403C21.4496 15.5248 21.3602 14.9963 20.9908 14.6876C20.0413 13.8938 19.5576 13.44 19.5576 12ZM11.8129 16.1177C9.54235 16.1177 7.69529 14.2706 7.69529 12C7.69529 9.72941 9.54235 7.88235 11.8129 7.88235C14.0835 7.88235 15.9306 9.72941 15.9306 12C15.9306 14.2706 14.0835 16.1177 11.8129 16.1177Z" />
            </svg>
          </button>
          <button
