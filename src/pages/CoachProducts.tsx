...
export default function CoachProducts() {
  useEffect(() => {
    document.title = "Leland Prototype | Offerings";
  }, []);

  return (
    <div>
      <div className="flex items-center justify-between gap-4">
        <h1 className="text-[30px] font-medium text-gray-dark md:text-[38px]">Offerings</h1>
        <Button size="md" variant="primary">New offering</Button>
      </div>
