...
export default function PageShell({
  ...
  //
  // Sticky offset pins the columns at the 61px sticky TopNav's bottom edge, so
  // they run full-height from just under the nav to the bottom of the viewport
  // (max-h = 100vh - 61px) and scroll their own overflow. A tall sidebar is
  // therefore clipped only by the nav (top) and the page edge (bottom), not by
  // any extra padding inset.
  ...
  const leftClass = leftSidebarMobile
    ? "w-full shrink-0 md:w-[300px] md:sticky md:top-[61px] md:self-start md:max-h-[calc(100vh-61px)] md:overflow-y-auto"
    : "hidden w-[300px] shrink-0 sticky top-[61px] self-start max-h-[calc(100vh-61px)] overflow-y-auto min-[960px]:block";
  ...
  const rightClass = stackRight
    ? hasBoth
      ? "w-full shrink-0 min-[1200px]:w-auto min-[1200px]:sticky min-[1200px]:top-[61px] min-[1200px]:self-start min-[1200px]:max-h-[calc(100vh-61px)] min-[1200px]:overflow-y-auto"
      : "w-full shrink-0 min-[960px]:w-auto min-[960px]:sticky min-[960px]:top-[61px] min-[960px]:self-start min-[960px]:max-h-[calc(100vh-61px)] min-[960px]:overflow-y-auto"
    : hasBoth
      ? "hidden shrink-0 sticky top-[61px] self-start max-h-[calc(100vh-61px)] overflow-y-auto min-[1200px]:block"
      : "hidden shrink-0 sticky top-[61px] self-start max-h-[calc(100vh-61px)] overflow-y-auto min-[960px]:block";
