...
export const IconSave: FC<SVGProps<SVGSVGElement>> = ({ ...props }) => {
  return (
    <svg
      {...props}
      viewBox="0 0 24 24"
    ...
    >
      ...
      ></path>
      <path
        d="M15.9932 3V6.909C15.9932 7.461 15.5452 7.909 14.9932 7.909H8.99316C8.44116 7.909 7.99316 7.461 7.99316 6.909V3"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
