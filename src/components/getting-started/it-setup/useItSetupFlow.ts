...
import type { ConnectorKey, VendorKey } from "./data";
...
// Counted steps map to their progress number; connectors-intro holds the prior
// number so the bar never snaps backward on that transition screen.
